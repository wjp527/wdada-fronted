...
const __VLS_33 = __VLS_asFunctionalComponent(__VLS_32, new __VLS_32({
    ...{ style: ({ width: '320px' }) },
    modelValue: (__VLS_ctx.searchParams.appId),
    placeholder: "请选择应用类型",
    allowClear: true,
}));
...
{
    const { appId: __VLS_thisSlot } = __VLS_75.slots;
    const [{ record }] = __VLS_getSlotParams(__VLS_thisSlot);
    (__VLS_ctx.APP_TYPE_MAP[record.appId]);
}
{
...
// @ts-ignore
const __VLS_113 = __VLS_asFunctionalComponent(UserModal, new UserModal({
    ...{ 'onOk': {} },
    ...{ 'onCancel': {} },
