  ...
  <div class="admin-user-answer">
    <a-form :model="searchParams" @submit="loadData">
      <a-row :gutter="16">
        ...
        <a-col :span="8">
          <a-form-item field="appId" label="应用类型" label-col-flex="80px">
            <a-select :style="{ width: '320px' }" v-model="searchParams.appId" placeholder="请选择应用类型" allow-clear>
...
import { addUserAnswerUsingPost, deleteUserAnswerUsingPost, listUserAnswerByPageUsingPost, updateUserAnswerUsingPost } from '@/api/userAnswerController'
...
const handleUserId = async (record: API.UserAnswer) => {
