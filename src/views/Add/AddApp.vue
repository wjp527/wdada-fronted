<template>
  <div id="addAppPage" class="flex flex-col items-center justify-center">
    ...
    <a-form :model="form" :style="{ width: '480px' }" label-align="left" auto-label-width @submit="handleSubmit">
      ...
      <a-form-item field="appIcon" label="应用图标">
        <Picture-uploader biz="app_icon" v-model="form.appIcon" :value="form.appIcon"></Picture-uploader>
      </a-form-item>
      ...
      <a-form-item field="scoringStrategy" label="评分策略">
        <a-select v-model="form.scoringStrategy" :style="{ width: '320px' }" placeholder="请选择评分策略">
          <a-option v-for="(value, key) of SCORE_STRATEGY_MAP" :value="Number(key)" :label="value" />
        </a-select>
      </a-form-item>
      <a-form-item>
